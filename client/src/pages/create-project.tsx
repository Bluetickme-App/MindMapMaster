...
export default function CreateProjectPage() {
  ...
  const { data: githubRepos = [], refetch: refetchGitHub } = useQuery<GitHubRepo[]>({
  ...
  const generateProject = useMutation({
    ...
    onSuccess: (data) => {
      toast({
        ...
        description: `${data.name} has been generated with AI`,
      });
      queryClient.invalidateQueries({ queryKey: ['/api/projects'] });
      setLocation('/workspace');
    },
  ...
  const quickTemplates = [
    { id: 'portfolio', name: 'Portfolio Website', icon: Globe, description: 'Personal portfolio with projects showcase' },
    { id: 'blog', name: 'Blog Platform', icon: Code, description: 'Modern blog with CMS capabilities' },
    { id: 'ecommerce', name: 'E-commerce Store', icon: Smartphone, description: 'Online store with payment integration' },
    { id: 'dashboard', name: 'Admin Dashboard', icon: Database, description: 'Analytics dashboard with charts' },
    { id: 'api', name: 'REST API', icon: Database, description: 'Backend API with authentication' },
    { id: 'mobile', name: 'Mobile App', icon: Smartphone, description: 'Cross-platform mobile application' },
  ];
  ...
  const handleStartBuild = () => {
    ...
    generateProject.mutate(projectPrompt);
  };
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold">
          Hi {userData?.name?.split(' ')[0] || 'Developer'}, what do you want to make?
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-2 mt-4">
          {['Workout tracker', 'Link in bio', 'Gym buddy finder', 'Task manager', 'Recipe app'].map((suggestion) => (
            <Button
              key={suggestion}
              variant="outline"
              size="sm"
        ...
        <TabsContent value="github" className="space-y-6">
          ...
          {githubRepos.length > 0 ? (
            ...
            <Alert>
              ...
              <AlertDescription>
                No GitHub repositories found. Make sure you've configured your GitHub token in Settings.
              </AlertDescription>
            </Alert>
          )}
        </TabsContent>
        ...
        <TabsContent value="recent" className="space-y-6">
          ...
          {recentProjects.length > 0 ? (
            ...
            <Alert>
              ...
              <AlertDescription>
                No projects yet. Create your first project using one of the options above.
              </AlertDescription>
            </Alert>
          )}
        </TabsContent>
